...
message3 = tk.Label(window, text="Real Time Face Recognition for secure Access Control" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
trackImg = tk.Button(frame1, text="Recognize Face", command=TrackImages  ,fg="black"  ,bg="#3ffc00"  ,width=35  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
